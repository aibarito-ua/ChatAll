...
export default class GradioBot2 extends Bot {
  static _brandId = "gradio2"; // Brand id of the bot, should be unique. Used in i18n.
  static _className = "GradioBot2"; // Class name of the bot
          ...
          if (event.msg === "send_hash") {
            ...
            if (event.rank > 0) {
              ...
              onUpdateResponse(callbackParam, {
                content: i18n.global.t("gradio2.waiting", { ...event }),
                done: false,
              });
            }
            ...
            reject(i18n.global.t("gradio2.queueFull"));
          }
        });
